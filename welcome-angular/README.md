# Welcome Angular PostgreSQL.

> Grettings with postgresql and angular in express route..
...
```bash
$ docker-compose -p "welcome-angular" -f web.yml -f model.yml up -d
```

### Development

```bash
$ docker-compose -p "welcome-angular-dev" -f web.yml -f model.yml -f development up
```
...
const { createRouter } = require("@mapineda48/welcome-angular");
