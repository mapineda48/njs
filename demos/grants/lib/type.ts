import type { State as StateOpportunity } from "../frontend/src/Opportunity";
import type { State as StateDetail } from "../frontend/src/Detail";
...
export const go = {
  opportunity(page: number) {
    return route.opportunity.replace(":page", page.toString());
  },
 ...
 * Types
 */
export type InitState = Opportunity | Detail;

export interface Detail {
  type: "Detail";
  state: Pick<StateDetail, "data">;
}

export interface Opportunity {
  type: "Opportunity";
  state: Pick<StateOpportunity, "data" | "pagination">;
}
