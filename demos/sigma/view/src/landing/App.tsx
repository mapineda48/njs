...
export default function Landing() {
  ...
  return (
    <div className="landing">
      ...
      <div className="text">
        <p>
          Lorem ipsum dolor, sit amet consectetur adipisicing elit. Vero vel sed
          reiciendis officia, illo atque numquam alias non dolore incidunt
          excepturi consequuntur aut omnis assumenda nesciunt. Quis nulla omnis
          neque.
        </p>
      </div>
