...
export default () => {
  ...
  const state: PreviewEmployee = useSelector(
  ...
  return (
    <Form>
      ...
      <Field label="Telefono" from={1} to={6}>
        <Input.Text
          value={state.phone}
      ...
      <Field label="Usuario" from={6} to={9}>
        <Input.Text
          value={state.username}
          onChangeValue={(username) => management.update({ username } as any)}
          type="tel"
        />
      </Field>
    </Form>
